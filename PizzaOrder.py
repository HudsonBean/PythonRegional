...
while (i < numberOfPizzas):
   ...
   while (True):
      menuCode = input("Please enter a 3 letter/number menu code for pizza number " + str(i+1) +".\n>")
      #SC2 Validity checks
      ...
      if (len(menuCode) == 3):
         ...
         if (canContinue == True):
            #Save data
            #Create dict for my data
            pizzas[i] = {}
            #Add the menuCode to the data
            pizzas[i]["menuCode"] = menuCode
            break
         else:
